...
if test $PHP_GIT != "no"; then
  ...
  PHP_NEW_EXTENSION(git,php_git.c repository.c signature.c commit.c index_entry.c index.c tree.c blob.c tree_entry.c walker.c object.c rawobject.c tag.c odb.c backend.c, $ext_shared)
